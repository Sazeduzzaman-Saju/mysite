...
const EducationExperience = () => {
  return (
    <div className="saju_tm_resumebox w-full h-auto clear-both float-left bg-white py-[93px] px-0">
      <div className="container">
        <div className="in w-full h-auto clear-both float-left flex">
          <div className="left w-1/2 pr-[50px]">
            ...
            <div className="saju_tm_resume_list w-full h-auto clear-both float-left">
